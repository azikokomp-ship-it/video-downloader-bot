...
async def start_handler(message: types.Message):
    await message.answer(
        "Salom! 🤖\nMenga TikTok, Instagram, Facebook yoki Twitter (X) havolasini yuboring."
    )
...
async def link_handler(message: types.Message):
    ...
    # YouTube olib tashlandi, faqat qolgan barqaror tarmoqlar qoldi
    valid_domains = [
    ...
    if not any(domain in url for domain in valid_domains):
        await message.answer("Iltimos, faqat TikTok, Instagram, Facebook yoki Twitter havolalarini yuboring! ❌")
        return
    ...
    # Oddiy va xatosiz ishlaydigan sozlamalar
    ydl_opts = {
